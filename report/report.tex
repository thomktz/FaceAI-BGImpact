...
Observations:
\begin{enumerate}
  \item Even adjusted for image weight, the grey-background dataset seems to converge faster and to a lower value.
...
The grey-background eigenvectors seem to have a much more pronounced effect on the facial attributes, even though the eigenvalues are smaller. \\
...
\begin{figure}[H]
  ...
  \begin{minipage}{.81\linewidth}
      \centering
      \includegraphics[width=\linewidth]{eigen/grey_gan_5.png}
  \end{minipage}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{minipage}{.81\linewidth}
      \centering
      \includegraphics[width=\linewidth]{eigen/grey_gan_6.png}
  \end{minipage}
\end{figure}

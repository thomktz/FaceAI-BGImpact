<template>
  <header class="header flex items-center justify-between p-4">
    ...
    <nav class="right-section">
      ...
      <router-link to="/stylegan" class="hover:text-gray-100 px-2"
        >StyleGAN</router-link
      >
      <router-link to="/vae" class="hover:text-gray-100 px-2">VAE</router-link>
    </nav>
  </header>
...
export default {
  name: "MainLayout",
  setup() {
    const headerTitle = ref("Advanced Machine Learning Project");
